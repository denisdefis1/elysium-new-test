...
const RSA_K3_DESCS = [
  'Бутик не значит меньше: 130 м², свободная планировка, панорамный вид.',
  'Дом введён в эксплуатацию. Только 14 апартаментов от 130 м². Показ по записи.',
  'Два апартамента на этаже. Тишина, панорамный вид, подземный паркинг.',
  'Панорамный вид, тишина, паркинг — не как дополнение, а как стандарт.',
];
...
const RSA_K4_RU_DESCS = [
  ...
  'Генератор, резервуар с водой, паркинг — в готовом доме. Пока другие строятся.',
